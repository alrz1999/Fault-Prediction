...
class FileLevelDatasetImporterStage(PipelineStage):
    ...
    def process(self):
        ...
        self.stage_data['file_level_df'] = self.result
...
class FileLevelTokenizerStage(PipelineStage):
    ...
    def process(self):
        df = self.stage_data['file_level_df']
        files_tokens = []
        ...
        self.stage_data['file_level_tokens'] = self.result
...
class LineLevelToFileLevelDatasetMapperStage(PipelineStage):
    ...
    def process(self):
        line_level_df = self.stage_data['line_level_df']
